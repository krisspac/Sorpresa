...
document.getElementById('siBtn').addEventListener('click', function() {
    ...
    document.getElementById('messageContainer').innerHTML = 'OOOOh😱 Amor TE AMOOOOOO😊';
    confetti({
        particleCount: 100,
        spread: 70,
        origin: { y: 0.6 }
    ...
    setTimeout(function() {
        document.getElementById('messageContainer').innerHTML += '<br>¿Qué te parece si vamos a cenar?';
    }, 3000);
    
    setTimeout(function() {
        document.getElementById('messageContainer').innerHTML += '<br>O tal vez prefieras escoger algo que te guste... 😏';
    }, 6000);
    setTimeout(function() {
        document.getElementById('messageContainer').innerHTML += '<br>❤️❤️❤️❤️❤️❤️';
    }, 8000);
